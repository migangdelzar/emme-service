...
/**
 * Dynamic JWT decoder that resolves the JWKS URI from the JWT's "iss" claim.
 * Each Keycloak realm has its own certs endpoint.
 */
@Component
public class MultiRealmJwtDecoder implements JwtDecoder {
    ...
    public Jwt decode(String token) throws JwtException {
        ...
        NimbusJwtDecoder decoder = decoders.computeIfAbsent(issuer, iss -> {
