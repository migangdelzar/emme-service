...
class AiCapabilityConventionTest {
  ...
  void keepsProviderImplementationsBehindApplicationPorts() throws Exception {
    ...
    assertThat(
        ...
        .isFalse();
    assertThat(Files.exists(contractsRoot.resolve("model/AiModelProvider.java"))).isFalse();
    assertThat(
    ...
    assertThat(Files.exists(contractsRoot.resolve("embedding/EmbeddingService.java"))).isTrue();
