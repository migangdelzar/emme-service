...
import com.emme.buildlogic.model.ContainerRuntime
...
abstract class EmmeContainerExtension @Inject constructor(
    ...
    init {
        ...
        runtime.convention(
            providers.gradleProperty("emme.container.runtime")
        ...
        imageName.convention(
            providers.gradleProperty("emme.container.imageName")
