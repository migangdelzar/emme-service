...
| `assistant` | [assistant module migration](2026-07-31-assistant-module-template-migration.md) | Canonical conversation, AI, and participant boundaries complete; webhook evidence remains | Keep AI providers, conversations, participants, and WhatsApp webhook boundaries isolated |
