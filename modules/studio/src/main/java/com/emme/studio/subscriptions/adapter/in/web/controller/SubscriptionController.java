...
public class SubscriptionController {
  ...
  public ResponseEntity<Void> enforce(
    ...
    enforceEntitlement.enforce(new EnforceEntitlementCommand(tenantId, request.entitlement()));
  ...
  public ResponseEntity<SubscriptionResponse> changePlan(
    ...
    SubscriptionInfo subscription = changeSubscriptionPlan.change(request.toCommand(tenantId));
