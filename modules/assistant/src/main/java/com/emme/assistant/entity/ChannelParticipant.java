...
public class ChannelParticipant extends TenantOwnedEntity {
  ...
  protected ChannelParticipant() {}

  public ChannelParticipant(UUID tenantId, ChannelType channel, String providerReference) {
    super(tenantId);
