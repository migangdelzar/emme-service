...
abstract class EmmeDeploymentExtension @Inject constructor(
    ...
    init {
        target.convention(
            providers.gradleProperty("emme.deployment.target")
                .orElse(providers.environmentVariable("EMME_DEPLOYMENT_TARGET"))
                .orElse("compose"),
        )
        profile.convention(
            providers.gradleProperty("emme.deployment.profile")
