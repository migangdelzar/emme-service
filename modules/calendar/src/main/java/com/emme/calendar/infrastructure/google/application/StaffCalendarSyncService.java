...
@Service
@Transactional
public class StaffCalendarSyncService {

  private static final Logger log = LoggerFactory.getLogger(StaffCalendarSyncService.class);
  ...
  public StaffCalendarSyncService(
  ...
  private String resolveAccessToken(UUID tenantId) {
    List<GoogleOAuthToken> tokens = tokenRepo.findByTenantId(tenantId);
