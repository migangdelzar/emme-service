 ...
 *
 * <p>Creates tenants via POST /api/tenants. The platform handles everything:
 * schema migration, Keycloak realm creation, and admin user provisioning
 * via its event-driven provisioning chain.
 *
...
public final class E2eProvisionerApplication {
  ...
  public static void main(String[] args) throws Exception {
    var template = JSON.readTree(E2eProvisionerApplication.class
        .getClassLoader().getResourceAsStream("tenants-e2e.json"));
