...
/**
 * Auto-creates a customer membership record when a customer creates their
 * first appointment at a tenant. This links the global customer identity
 * to the tenant so the customer appears in the business dashboard.
 */
@Component
