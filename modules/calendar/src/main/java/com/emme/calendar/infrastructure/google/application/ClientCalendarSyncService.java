 ...
 */
@Service
public class ClientCalendarSyncService {

  private static final Logger log = LoggerFactory.getLogger(ClientCalendarSyncService.class);
  ...
  public ClientCalendarSyncService(
      GoogleOAuthService oauthService, CalendarSyncApi syncApi, ObjectMapper mapper) {
