...
| Tenant full-context test fixture | Replacement tested | Remove unused salon business-profile, identity membership, and identity role repositories from `BaseTenantModuleTest`; Identity tests now own their role/membership setup, while cross-module subscription and feature-flag setup remains until the larger fixture split is dependency-safe. | 2026-09-05 |
