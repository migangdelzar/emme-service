...
| Tenant full-context test fixture | Replacement tested | Remove unused salon business-profile and identity membership repositories from `BaseTenantModuleTest`; retain only collaborators with active consumers until the remaining feature-specific setup can be split without broad fixture churn. | 2026-09-05 |
