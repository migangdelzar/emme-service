...
public record NodeMemoryPolicy(Set<String> allowedScopes, int maxTurns, boolean includeLongTerm) {
  ...
  public Set<String> filterScopes(Set<String> candidateScopes) {
    Objects.requireNonNull(candidateScopes, "candidateScopes must not be null");
    return candidateScopes.stream()
